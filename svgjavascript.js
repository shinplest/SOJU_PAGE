...
function show(resign) {
    switch (resign) {
        case seoul:
            ...
            document.getElementById("seoul_text").style.display = "inline";
            break;
        case gangwon:
            document.getElementById("gangwon").style.display = "inline";
            document.getElementById("gangwon_text").style.display = "inline";
            break;
        case choongnam:
            document.getElementById("choongnam").style.display = "inline";
            document.getElementById("choongnam_text").style.display = "inline";

            break;
        case choongbook:
            document.getElementById("choongbook").style.display = "inline";
            document.getElementById("choongbook_text").style.display = "inline";

            break;
        case kyoungbook:
            document.getElementById("kyoungbook").style.display = "inline";
            document.getElementById("kyoungbook_text").style.display = "inline";

            break;
        case jeounbook:
            document.getElementById("jeounbook").style.display = "inline";
            document.getElementById("jeounbook_text").style.display = "inline";

            break;
        case kyoungnam:
            document.getElementById("kyoungnam").style.display = "inline";
            document.getElementById("kyoungnam_text").style.display = "inline";

            break;
        case jeounnam:
            document.getElementById("jeounnam").style.display = "inline";
            document.getElementById("jeounnam_text").style.display = "inline";

            break;
        case jeju:
            document.getElementById("jeju").style.display = "inline";
            document.getElementById("jeju_text").style.display = "inline";

            break;
        case busan:
            document.getElementById("busan").style.display = "inline";
            document.getElementById("busan_text").style.display = "inline";
